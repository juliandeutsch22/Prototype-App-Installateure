...
| **Angebote** | Positionen kalkulieren, Arbeitszeit getrennt ausweisen (der Haken folgt der Einheit, bis man ihn selbst setzt), beim Annehmen Baustelle mit Stundenbudget anlegen — ist die aus der Angebotsnummer abgeleitete Baustellennummer vergeben, kommt die nächste aus dem Zähler | Buchhaltung, Leitung | `quotes`, `projects`, `counters` | Ansicht (10), Datenbank (31: Geld, darin der Zähler — steigend, Neubeginn nur zum Jahreswechsel) | — |
